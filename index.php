...
<html>
    ...
    <body>
          ...
          <div class="col-md-12 navbar navbar-default">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group col-md-2">
                        ...
                        <button type="submit" class="btn btn-primary form-control col-md-2" id="login-button">Log in</button>
                </div>
                </form>
            </div> 
        ...
        <div class="row">
          <div class="col-md-12">
             <div class="col-md-6 col-md-offset-6"><h2>Sign Up</h2></div>             
          </div>
        ...
        <div class="row">
            <div class="col-md-12">
              <div class="col-md-5 col-md-offset-1">
                <h2>Connect with all of your friends!</h2>
                <ul>
                    <li>See photos and updates in your news feed</li><br />
                    <li>Post your status for the world to see from your profile</li><br />
                    <li>Get in touch with your friends by "friending" them</li><br />
                    <li>Like things because you're a positive person</li><br />
                </ul>
            </div>
              <div class="col-md-4">
                ...
                <div class="form-group no-left-padding col-md-6">
                        <input type="text" class="form-control" id="inputFirstName" placeholder="FirstName">
                </div>
                <div class="form-group no-right-padding col-md-6">
                        <input type="password" class="form-control" id="inputLastName" placeholder="LastName">
                </div>
                <div class="form-group">
                        <input type="email" class="form-control" id="inputEmail" placeholder="Your Email">
                </div>
                <div class="form-group">
                        <input type="password" class="form-control" id="inputPassword1" placeholder="Your New Password">
                </div>
                <div class="form-group">
                ...
                <br />
                <div class="col-md-12 no-left-padding"><strong>Birthday</strong></div>
                ...
                <div class="form-group">
                        <button type="email" class="btn btn-success form-control col-md-2" id="signup-button">Sign Up!</button>
                </div>
              </div>
